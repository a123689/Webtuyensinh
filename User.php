...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="User.php"><i class="fas fa-users"></i><span>User</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid"><table id="example" class="table table-striped table-bordered" width="100%">
    <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
    ...
    <tbody>
         <?php
              ...
              $account = getUser();
              while( $row_account = mysqli_fetch_array($account,MYSQLI_ASSOC) ){
	    ...
	    <tr>
         ...
         <?php
                    $s = ob_get_clean();
                    $s = str_replace("{id}", $row_account["ID"], $s); // thay thế
                    $s = str_replace("{name}", $row_account["Name"], $s);
                    $s = str_replace("{email}", $row_account["Email"], $s);
                    $s = str_replace("{password}", $row_account["Password"], $s);
                    $s = str_replace("{startdate}", $row_account["StartDate"], $s);
                    $s = str_replace("{lever}", $row_account["Lever"], $s);
