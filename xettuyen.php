...
<main class="main-content" style="margin-top:90px">
    ...
    <div class="col">
        ...
        <div class="row">
            <div class="col-sm-4 col-12">
                ...
                <input type="text" id="BirthDate" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" >
            </div>
            <div class="col-sm-4 col-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-12">
                ...
                <input type="text" id="CitizenIdIssueDate" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
            </div>
            <div class="col-sm-4 col-12">
    ...
    <div ng-show="item.Id>0" class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div style="border-bottom:0px solid #AAA;padding-top:10px;margin-bottom: 15px;" ng-click="ShowAspire()">
            ...
            <div ng-show="ViewAspireForm">
                <div class="row">
                    <div class="col-sm-6 col-12">
                        ...
                        <select ng-model="item.Aspiration.EduBaseCode" ng-options="sc.BaseCode as sc.Name for (key, sc) in AllEducationBase" ng-change="EducationBaseChange(item.Aspiration.EduBaseCode)" class="form-control select2 ng-pristine ng-untouched ng-valid ng-empty select2-hidden-accessible" style="width: 100%;" ng-disabled="item.ProgressStep==4" tabindex="-1" aria-hidden="true"><option value="?" selected="selected"></option><option label="Cơ sở Hà Nội" value="string:TLA">Cơ sở Hà Nội</option><option label="Cơ sở Phố Hiến" value="string:PHA">Cơ sở Phố Hiến</option><option label="Phân hiệu Miền Nam" value="string:TLS">Phân hiệu Miền Nam</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-ioym-container"><span class="select2-selection__rendered" id="select2-ioym-container" title=""></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                    </div>
                    <div class="col-sm-6 col-12">
                        <label>Nguyện vọng:</label>
                        <select ng-model="item.Aspiration.AspirationOrder" ng-options="sc.Id as sc.Name for (key, sc) in MyAspiration" ng-change="AspirationChange(item.Aspiration.AspirationOrder,'')" class="form-control select2 ng-pristine ng-untouched ng-valid ng-empty select2-hidden-accessible" style="width: 100%;" ng-disabled="item.ProgressStep==4" tabindex="-1" aria-hidden="true"><option value="?" selected="selected"></option><option label="Nguyện vọng 2" value="number:2">Nguyện vọng 2</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-c8tr-container"><span class="select2-selection__rendered" id="select2-c8tr-container" title=""></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        ...
                        <select ng-model="item.Aspiration.ProgramCode" ng-options="sc.ProgramCode as sc.ProgramsName for (key, sc) in EducationBase.educationPrograms" class="form-control select2 ng-pristine ng-untouched ng-valid ng-empty select2-hidden-accessible" style="width: 100%;" ng-disabled="item.ProgressStep==4" tabindex="-1" aria-hidden="true"><option value="?" selected="selected"></option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-ycy1-container"><span class="select2-selection__rendered" id="select2-ycy1-container" title=""></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>Mã xét tuyển :</label>
                        <input type="text" ng-model="item.Aspiration.ProgramCode" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" placeholder="mã xét tuyển" required="" disabled="">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>Tổ hợp xét tuyển:</label>
                        <select ng-model="item.Aspiration.CombinCode" ng-options="sc.CombinCode as sc.CombinName for (key, sc) in AllCombination" ng-change="CombinationChange(item.Aspiration.CombinCode)" class="form-control select2 ng-pristine ng-untouched ng-valid ng-empty select2-hidden-accessible" style="width: 100%;" ng-disabled="item.ProgressStep==4" tabindex="-1" aria-hidden="true"><option value="?" selected="selected"></option><option label="A00" value="string:A00">A00</option><option label="A01" value="string:A01">A01</option><option label="A02" value="string:A02">A02</option><option label="B00" value="string:B00">B00</option><option label="D01" value="string:D01">D01</option><option label="D07" value="string:D07">D07</option><option label="D08" value="string:D08">D08</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-33bg-container"><span class="select2-selection__rendered" id="select2-33bg-container" title=""></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                    </div>
                </div>
                <!--Điểm lớp 10 THPT-->
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <label>Lớp 10 :</label><span ng-bind-html="CombinSubjectByCode[0].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA10_1" id="GPA10_1" placeholder="Điểm trung bình cả năm môn 1 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[1].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA10_2" id="GPA10_2" placeholder="Điểm trung bình cả năm môn 2 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[2].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA10_3" id="GPA10_3" placeholder="Điểm trung bình cả năm môn 3 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                </div>
                <!--Điểm lớp 11 THPT-->
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <label>Lớp 11 :</label><span ng-bind-html="CombinSubjectByCode[0].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA11_1" id="GPA11_1" placeholder="Điểm trung bình cả năm môn 1 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[1].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA11_2" id="GPA11_2" placeholder="Điểm trung bình cả năm môn 2 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[2].SubjectCode" class="ng-binding"></span>
                        <input type="number" min="0" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-min ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA11_3" id="GPA11_3" placeholder="Điểm trung bình cả năm môn 3 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                </div>
                <!--Điểm lớp 12 THPT-->
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <label>Lớp 12 :</label><span ng-bind-html="CombinSubjectByCode[0].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA12_1" id="GPA12_1" placeholder="Điểm trung bình cả năm môn 1 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[1].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA12_2" id="GPA12_2" placeholder="Điểm trung bình cả năm môn 2 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                    <div class="col-sm-4 col-12">
                        <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[2].SubjectCode" class="ng-binding"></span>
                        <input type="number" max="10" class="form-control ng-pristine ng-untouched ng-empty ng-valid-max ng-invalid ng-invalid-required" ng-model="item.Aspiration.GPA12_3" id="GPA12_3" placeholder="Điểm trung bình cả năm môn 3 " required="" ng-disabled="item.ProgressStep==4">
                    </div>
                </div>
                <div class="row">
                    ...
                    <table class="table table-bordered table-hover ng-hide" style="background-color:white" ng-show="item.candidateAttachments.length>0">
            ...
            <div class="col-md-12" ng-show="item.aspirationDtos.length>0">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="border-bottom:0px solid #AAA;padding-top:10px;margin-bottom: 15px;" ng-click="ShowAttachFile()" ng-show="!ViewAttachForm" class="ng-hide">
                ...
                <div ng-show="ViewAttachForm" id="attachfile">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="padding-top: 30px;">
                            ...
                            <input type="file" id="fileAttach" ng-model="fileAttachs" ngf-select="" ngf-multiple="true" class="form-control ng-pristine ng-untouched ng-valid ng-empty" onchange="angular.element(this).scope().loadFile(this.files)" ng-disabled="item.ProgressStep==4" multiple="multiple">
                        </div>
                    </div>
